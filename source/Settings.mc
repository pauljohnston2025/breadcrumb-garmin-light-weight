...
class Settings {
    ...
    var centerUserOffsetY as Float = 0.25f; // percentage of the screen to move the user down the page 0.5 - user appears in center, 0.75 - user appears 3/4 down the screen. Useful to see more of the route infront of the user. - TODO ADD SETTINGS SUPPORT - needs to call view.onSettingsChanged for the bitmap size change, and change the cached values first
    var mapMoveScreenSize as Float = 0.5f; // how far to move thve map when the user presses on screen buttons, a fraction of the screen size.  - TODO ADD SETTINGS SUPPORT
